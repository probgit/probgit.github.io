...
$header .= "From: Новая заявка <garibzyanov @gmail.com>\n\n";	
$mail = mail("garibzyanov@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
